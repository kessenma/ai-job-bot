...
const Example = () => (
  <Dialog>
    <DialogTrigger render={<Button variant="outline" />}>View Privacy Policy</DialogTrigger>
      ...
      <ScrollArea className="h-[300px] pr-4">
        <div className="space-y-4 text-sm">
          ...
          <p>
            ...
            we have grouped together as follows: Identity Data, Contact Data, Technical Data,
            Profile Data, Usage Data, Marketing and Communications Data.
          </p>
          ...
          <p>
            ...
            use your personal data in the following circumstances: where we need to perform the
            contract we are about to enter into or have entered into with you, where it is necessary
            for our legitimate interests, and where we need to comply with a legal obligation.
          </p>
