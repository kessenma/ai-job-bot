...
const tabs = [
  ...
  },
  {
    id: "settings",
    label: "Settings",
    content: "Configure project settings including permissions, integrations, and preferences.",
  },
]
    ...
    <Sheet>
      ...
      <SheetContent>
        <SheetHeader>
          ...
          <SheetDescription>View and manage project information</SheetDescription>
        </SheetHeader>
